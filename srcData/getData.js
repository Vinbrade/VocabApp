...
const gg900Data = JSON.parse(fs.readFileSync("views/assets/gg900.json", "utf-8"));
const data = [easyData, mediumData, advancedData, etsEssentialData, etsAdvancedData, gg900Data];
