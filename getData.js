...
const etsEssentialData = JSON.parse(fs.readFileSync("public/assets/ets_essential.json", "utf-8"));
const etsAdvancedData = JSON.parse(fs.readFileSync("public/assets/ets_advanced.json", "utf-8"));
